...
3. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО: схемы, диаграммы, инфографика, текст/надписи на изображении, абстрактные концепции, коллажи из множества элементов, таблицы, графики
4. Используй format "slider" только для пошаговых процессов или сравнений
