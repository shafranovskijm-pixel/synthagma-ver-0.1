...
8. Используй маркеры оформления:
  - :::warning текст ::: — для предупреждений и опасных факторов
  - :::info текст ::: — для нормативных ссылок
  - :::danger текст ::: — для критических нарушений
  - :::highlight текст ::: — для ключевых выводов${contextNote}`;
      } else {
...
7. ОБЯЗАТЕЛЬНО используй специальные маркеры для визуального оформления:
  - :::warning текст ::: — для предупреждений, техники безопасности, опасных факторов
  - :::info текст ::: — для справочной информации, нормативных ссылок, определений
  - :::tip текст ::: — для практических советов и рекомендаций
  - :::danger текст ::: — для критически важной информации, запретов, грубых нарушений
  - :::highlight текст ::: — для ключевых определений и терминов (выделение)
  - :::accordion Заголовок секции\nтекст\n::: — для дополнительных/справочных материалов (сворачиваемая секция)
8. На каждые 3-4 параграфа — минимум 1 блок с маркером (:::warning, :::info, :::tip и т.п.). Это ОБЯЗАТЕЛЬНО.${contextNote}`;
      }
