...
7. Проверяй актуальность нормативно-правовых документов и законов. Ссылайся только на действующие редакции НПА, приказов, постановлений и ГОСТов. Если документ отменён или заменён — используй актуальную версию.
8. Актуализируй информацию: перепроверяй себя, не используй устаревшие данные, нормы и формулировки.`;
