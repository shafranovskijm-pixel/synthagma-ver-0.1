              ...
              <TooltipProvider>
                ...
                <Suspense fallback={<LazyLoadFallback />}>
                  <Routes>
                    ...
                    <Route path="/organization/documents" element={
                      <ProtectedRoute requiredRole="organization">
                        <OrganizationDocuments />
                      </ProtectedRoute>
                    } />
                    <Route path="/organization/course/:courseId" element={
                      <ProtectedRoute requiredRole="organization">
                        <OrganizationCourseDetails />
                      </ProtectedRoute>
                    } />
                    <Route path="/organization/whats-new" element={
                      <ProtectedRoute requiredRole="organization">
                        <OrganizationWhatsNew />
                      </ProtectedRoute>
                    } />
                    <Route path="/organization/help" element={
                      <ProtectedRoute requiredRole="organization">
                        <OrganizationHelp />
                      </ProtectedRoute>
                    } />
                    <Route path="/organization/student/:studentId" element={
                      <ProtectedRoute requiredRole="organization">
                        <OrganizationStudentDetails />
                      </ProtectedRoute>
                    } />
