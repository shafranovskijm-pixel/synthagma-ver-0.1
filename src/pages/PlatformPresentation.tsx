...
function SlideTitlePage() {
  return (
    <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-[hsl(0_0%_8%)] to-[hsl(0_0%_18%)] text-white px-20">
      <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.8 }}>
        <div className="w-28 h-28 rounded-3xl bg-gradient-to-br from-[hsl(174_72%_46%)] to-[hsl(174_65%_35%)] flex items-center justify-center mb-10 mx-auto">
          <GraduationCap className="w-16 h-16 text-white" />
        </div>
      </motion.div>
      <h1 className="text-[96px] font-bold tracking-tight mb-6 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">СИНТАГМА</h1>
      <p className="text-[32px] text-white/60 font-light">Платформа для образовательных организаций</p>
      <div className="mt-16 flex gap-8">
        {["LMS", "Документооборот", "ИИ-ассистент", "ФИС ФРДО"].map(t => (
          <span key={t} className="px-6 py-3 rounded-full border border-white/20 text-[20px] text-white/70">{t}</span>
        ))}
      </div>
    </div>
  );
...
function SlideProblem() {
  ...
  return (
    <div className="flex flex-col h-full bg-[hsl(40_20%_98%)] px-24 py-20">
      <h2 className="text-[56px] font-bold text-[hsl(0_0%_8%)] mb-4">Проблема</h2>
      <p className="text-[28px] text-[hsl(0_0%_45%)] mb-16">С чем сталкиваются образовательные организации каждый день</p>
      <div className="grid grid-cols-2 gap-10 flex-1">
        {problems.map((p, i) => (
          <motion.div key={i} initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: i * 0.15 }}
            className="bg-white rounded-2xl p-10 border border-[hsl(40_15%_90%)] shadow-lg flex items-start gap-6">
            <div className="w-16 h-16 rounded-2xl bg-[hsl(0_72%_51%/0.1)] flex items-center justify-center flex-shrink-0">
              <p.icon className="w-8 h-8 text-[hsl(0_72%_51%)]" />
            </div>
            <div>
              <h3 className="text-[28px] font-semibold text-[hsl(0_0%_8%)] mb-2">{p.title}</h3>
              <p className="text-[22px] text-[hsl(0_0%_45%)]">{p.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
...
function SlideSolution() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-[hsl(174_72%_46%)] to-[hsl(174_65%_30%)] text-white px-24 py-20">
      <h2 className="text-[56px] font-bold mb-6">Единая платформа</h2>
      <p className="text-[28px] text-white/80 mb-16 text-center max-w-[1200px]">Всё для образовательной организации — от создания курсов до выгрузки в ФИС ФРДО</p>
      <div className="grid grid-cols-3 gap-8">
        {features.map((f, i) => (
          <motion.div key={i} initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: i * 0.1 }}
            className="bg-white/15 backdrop-blur-sm rounded-2xl p-8 flex flex-col items-center gap-4 w-[340px]">
  ...
  return (
    <div className="flex flex-col h-full bg-[hsl(40_20%_98%)] px-24 py-20">
      <div className="flex items-center gap-4 mb-4">
        <Building2 className="w-10 h-10 text-[hsl(174_72%_46%)]" />
        <h2 className="text-[48px] font-bold text-[hsl(0_0%_8%)]">Интерфейс организации</h2>
      </div>
      <p className="text-[24px] text-[hsl(0_0%_45%)] mb-12">Полный контроль над обучением и документооборотом</p>
      {/* Mock dashboard */}
      <div className="flex-1 bg-white rounded-3xl border border-[hsl(40_15%_90%)] shadow-xl overflow-hidden">
        <div className="h-14 bg-[hsl(0_0%_8%)] flex items-center px-6 gap-3">
          <div className="w-3 h-3 rounded-full bg-red-400" /><div className="w-3 h-3 rounded-full bg-yellow-400" /><div className="w-3 h-3 rounded-full bg-green-400" />
          <span className="text-white/60 ml-4 text-[16px]">СИНТАГМА — Панель управления</span>
        </div>
        <div className="p-8">
          <div className="grid grid-cols-4 gap-6 mb-8">
            {sections.map((s, i) => (
              <div key={i} className="rounded-2xl border border-[hsl(40_15%_90%)] p-6">
                <div className="flex items-center gap-3 mb-3">
                  <s.icon className="w-6 h-6" style={{ color: s.color }} />
                  <span className="text-[18px] text-[hsl(0_0%_45%)]">{s.label}</span>
                </div>
                <span className="text-[36px] font-bold text-[hsl(0_0%_8%)]">{s.value}</span>
              </div>
            ))}
          </div>
...
function SlideCourseManagement() {
  ...
  return (
    <div className="flex flex-col h-full bg-[hsl(40_20%_98%)] px-24 py-20">
      <h2 className="text-[48px] font-bold text-[hsl(0_0%_8%)] mb-4">Управление курсами</h2>
      <p className="text-[24px] text-[hsl(0_0%_45%)] mb-12">Создавайте, импортируйте или генерируйте курсы с ИИ</p>
      <div className="grid grid-cols-2 gap-8 flex-1">
        {types.map((t, i) => (
          <motion.div key={i} initial={{ x: i % 2 === 0 ? -30 : 30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: i * 0.12 }}
            className="bg-white rounded-2xl border border-[hsl(40_15%_90%)] p-10 shadow-md flex items-start gap-6">
            <div className="w-16 h-16 rounded-2xl bg-[hsl(174_72%_46%/0.1)] flex items-center justify-center flex-shrink-0">
              <t.icon className="w-8 h-8 text-[hsl(174_72%_46%)]" />
            </div>
            <div>
              <h3 className="text-[28px] font-semibold text-[hsl(0_0%_8%)] mb-2">{t.label}</h3>
              <p className="text-[22px] text-[hsl(0_0%_45%)]">{t.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
      <div className="mt-8 flex gap-6">
        {["Импорт из файлов", "Копирование курсов", "Шаблоны"].map(t => (
          <span key={t} className="px-5 py-2 rounded-full bg-[hsl(174_72%_46%/0.1)] text-[hsl(174_72%_46%)] text-[18px] font-medium">{t}</span>
        ))}
      </div>
    </div>
  );
...
function SlideCourseSettings() {
  ...
  return (
    <div className="flex flex-col h-full bg-[hsl(0_0%_8%)] text-white px-24 py-20">
      <h2 className="text-[48px] font-bold mb-4">Настройки курсов</h2>
      <p className="text-[24px] text-white/60 mb-12">Гибкая настройка для любых требований</p>
      <div className="grid grid-cols-2 gap-6 flex-1">
        {settings.map((s, i) => (
          <motion.div key={i} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.1 }}
            className="flex items-start gap-5 bg-white/5 rounded-xl p-6 border border-white/10">
            <s.icon className="w-7 h-7 text-[hsl(174_72%_46%)] flex-shrink-0 mt-1" />
            <div>
              <h3 className="text-[22px] font-semibold mb-1">{s.label}</h3>
              <p className="text-[18px] text-white/50">{s.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
...
function SlideStudentInterface() {
  return (
    <div className="flex flex-col h-full bg-[hsl(40_20%_98%)] px-24 py-20">
      <div className="flex items-center gap-4 mb-4">
        <GraduationCap className="w-10 h-10 text-[hsl(174_72%_46%)]" />
        <h2 className="text-[48px] font-bold text-[hsl(0_0%_8%)]">Интерфейс ученика</h2>
      </div>
      <p className="text-[24px] text-[hsl(0_0%_45%)] mb-12">Простой и понятный — ничего лишнего</p>
      <div className="flex-1 bg-white rounded-3xl border border-[hsl(40_15%_90%)] shadow-xl overflow-hidden">
        <div className="h-14 bg-[hsl(0_0%_8%)] flex items-center px-6 gap-3">
          <div className="w-3 h-3 rounded-full bg-red-400" /><div className="w-3 h-3 rounded-full bg-yellow-400" /><div className="w-3 h-3 rounded-full bg-green-400" />
          <span className="text-white/60 ml-4 text-[16px]">Мои курсы</span>
        </div>
        <div className="p-8 flex gap-8">
          <div className="flex-1 space-y-4">
            <h3 className="text-[22px] font-semibold text-[hsl(0_0%_8%)]">Назначенные курсы</h3>
            {[
              { name: "Охрана труда", progress: 85 },
              { name: "Электробезопасность", progress: 40 },
              { name: "Пожарная безопасность", progress: 0 },
            ].map((c, i) => (
              <div key={i} className="rounded-xl border border-[hsl(40_15%_90%)] p-5">
                <div className="flex justify-between mb-2">
                  <span className="text-[18px] font-medium text-[hsl(0_0%_8%)]">{c.name}</span>
                  <span className="text-[16px] text-[hsl(0_0%_45%)]">{c.progress}%</span>
                </div>
                <div className="h-2 bg-[hsl(40_15%_92%)] rounded-full">
                  <div className="h-2 bg-[hsl(174_72%_46%)] rounded-full" style={{ width: `${c.progress}%` }} />
                </div>
              </div>
            ))}
          </div>
...
function SlideAIAssistant() {
  return (
    <div className="flex h-full bg-gradient-to-br from-[hsl(262_80%_20%)] to-[hsl(262_60%_35%)] text-white px-24 py-20">
      <div className="flex-1 flex flex-col justify-center pr-16">
        <Brain className="w-16 h-16 mb-8 text-[hsl(262_80%_70%)]" />
        <h2 className="text-[56px] font-bold mb-6">ИИ-ассистент</h2>
        <p className="text-[26px] text-white/70 mb-10">Персональный консультант для каждого ученика</p>
        <div className="space-y-5">
          {[
            ...
            <motion.div key={i} initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: i * 0.15 }}
              ...
              <CheckCircle2 className="w-6 h-6 text-[hsl(174_72%_46%)] flex-shrink-0" />
              <span className="text-[22px]">{t}</span>
            </motion.div>
          ))}
        </div>
      </div>
...
function SlideCompanyInterface() {
  return (
    <div className="flex flex-col h-full bg-[hsl(40_20%_98%)] px-24 py-20">
      <div className="flex items-center gap-4 mb-4">
        <Building2 className="w-10 h-10 text-[hsl(38_92%_50%)]" />
        <h2 className="text-[48px] font-bold text-[hsl(0_0%_8%)]">Интерфейс компании</h2>
      </div>
      <p className="text-[24px] text-[hsl(0_0%_45%)] mb-12">Для заказчиков обучения — контроль сотрудников</p>
      <div className="flex-1 grid grid-cols-3 gap-8">
        {[
          ...
          <motion.div key={i} initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: i * 0.15 }}
            className="bg-white rounded-2xl border border-[hsl(40_15%_90%)] p-8 shadow-md">
            <div className="w-14 h-14 rounded-2xl bg-[hsl(38_92%_50%/0.1)] flex items-center justify-center mb-6">
              <s.icon className="w-7 h-7 text-[hsl(38_92%_50%)]" />
            </div>
            <h3 className="text-[26px] font-semibold text-[hsl(0_0%_8%)] mb-4">{s.title}</h3>
            <ul className="space-y-3">
              {s.items.map((item, j) => (
                <li key={j} className="flex items-center gap-3 text-[20px] text-[hsl(0_0%_45%)]">
                  <CheckCircle2 className="w-5 h-5 text-[hsl(142_70%_45%)]" />
                  {item}
                </li>
              ))}
            </ul>
...
function SlideDocuments() {
  ...
  return (
    <div className="flex flex-col h-full bg-[hsl(0_0%_8%)] text-white px-24 py-20">
      <h2 className="text-[48px] font-bold mb-4">Документооборот</h2>
      <p className="text-[24px] text-white/60 mb-12">Автоматическая генерация всех документов</p>
      <div className="grid grid-cols-3 gap-6 flex-1">
        {docs.map((d, i) => (
          <motion.div key={i} initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: i * 0.1 }}
            className="bg-white/5 rounded-xl border border-white/10 p-6 flex items-start gap-4">
            <d.icon className="w-8 h-8 text-[hsl(174_72%_46%)] flex-shrink-0" />
            <div>
              <h3 className="text-[20px] font-medium mb-2">{d.name}</h3>
              {d.auto && <span className="text-[14px] px-3 py-1 rounded-full bg-[hsl(174_72%_46%/0.2)] text-[hsl(174_72%_46%)]">Авто</span>}
            </div>
          </motion.div>
        ))}
      </div>
      <p className="mt-8 text-[22px] text-white/50 text-center">Шаблоны DOCX → автозаполнение данными ученика и организации</p>
    </div>
  );
}
...
function SlideDocChecklist() {
  ...
  return (
    <div className="flex h-full bg-[hsl(40_20%_98%)] px-24 py-20">
      <div className="flex-1 flex flex-col justify-center pr-16">
        <ClipboardList className="w-14 h-14 mb-6 text-[hsl(174_72%_46%)]" />
        <h2 className="text-[48px] font-bold text-[hsl(0_0%_8%)] mb-4">Чек-лист документов</h2>
        <p className="text-[24px] text-[hsl(0_0%_45%)] mb-10">Автоматический сбор документов от учеников</p>
        <div className="space-y-4">
          {items.map((item, i) => (
            <motion.div key={i} initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: i * 0.1 }}
              className="flex items-center gap-4">
              <CheckCircle2 className="w-6 h-6 text-[hsl(142_70%_45%)]" />
              <span className="text-[22px] text-[hsl(0_0%_8%)]">{item}</span>
            </motion.div>
          ))}
        </div>
      </div>
...
function SlideVideoId() {
  return (
    <div className="flex h-full bg-gradient-to-br from-[hsl(0_0%_8%)] to-[hsl(0_0%_15%)] text-white px-24 py-20">
      <div className="flex-1 flex flex-col justify-center pr-16">
        <Video className="w-14 h-14 mb-6 text-[hsl(174_72%_46%)]" />
        <h2 className="text-[48px] font-bold mb-4">Видеоидентификация</h2>
        <p className="text-[24px] text-white/60 mb-10">Верификация личности ученика по 273-ФЗ</p>
        <div className="space-y-5">
          {[
            ...
            <div key={i} className="flex items-center gap-4">
              <CheckCircle2 className="w-6 h-6 text-[hsl(174_72%_46%)]" />
              <span className="text-[22px]">{t}</span>
            </div>
          ))}
        </div>
...
function SlideFRDO() {
  return (
    <div className="flex flex-col items-center justify-center h-full bg-[hsl(40_20%_98%)] px-24 py-20">
      <Landmark className="w-16 h-16 text-[hsl(174_72%_46%)] mb-8" />
      <h2 className="text-[56px] font-bold text-[hsl(0_0%_8%)] mb-4">ФИС ФРДО</h2>
      <p className="text-[26px] text-[hsl(0_0%_45%)] mb-16 text-center max-w-[900px]">Автоматическая выгрузка данных о выданных документах в федеральный реестр</p>
      <div className="flex gap-8">
        {[
          ...
          <motion.div key={i} initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: i * 0.2 }}
            ...
            <div className="w-20 h-20 rounded-full bg-[hsl(174_72%_46%)] text-white flex items-center justify-center text-[36px] font-bold mb-6">{s.step}</div>
            <h3 className="text-[24px] font-semibold text-[hsl(0_0%_8%)] mb-2">{s.label}</h3>
            <p className="text-[20px] text-[hsl(0_0%_45%)] text-center">{s.desc}</p>
          </motion.div>
        ))}
      </div>
    </div>
...
function SlideMarketplace() {
  return (
    <div className="flex h-full bg-[hsl(0_0%_8%)] text-white px-24 py-20">
      <div className="flex-1 flex flex-col justify-center pr-16">
        <ShoppingBag className="w-14 h-14 mb-6 text-[hsl(174_72%_46%)]" />
        <h2 className="text-[48px] font-bold mb-4">Магазин курсов</h2>
        <p className="text-[24px] text-white/60 mb-8">Продавайте свои курсы другим организациям</p>
        <div className="space-y-4">
          {[
...
function SlideReadyCourses() {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-[hsl(174_72%_46%)] to-[hsl(174_60%_30%)] text-white px-24 py-20">
      <h2 className="text-[56px] font-bold mb-4">200+ готовых курсов</h2>
      <p className="text-[26px] text-white/80 mb-14">Программы по Ростехнадзору с актуальными тестами 2026 года</p>
      <div className="grid grid-cols-2 gap-8 flex-1">
        {categories.map((c, i) => (
          <motion.div key={i} initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: i * 0.12 }}
            className="bg-white/15 backdrop-blur-sm rounded-2xl p-8 border border-white/20 flex items-start gap-6">
            <div className="w-16 h-16 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0">
              <c.icon className="w-8 h-8" />
            </div>
            <div>
              <h3 className="text-[26px] font-semibold mb-1">{c.name}</h3>
              <span className="text-[36px] font-bold">{c.count}</span>
              <span className="text-[20px] text-white/70 ml-2">курсов</span>
            </div>
          </motion.div>
        ))}
      </div>
      <div className="mt-8 flex gap-6 justify-center">
        {["Актуальные тесты 2026", "Доступ 24/7", "Автообновление по НПА"].map(t => (
          <span key={t} className="px-6 py-3 rounded-full bg-white/20 text-[18px] font-medium">{t}</span>
        ))}
      </div>
    </div>
  );
...
function SlideMobile() {
  return (
    <div className="flex h-full bg-[hsl(0_0%_8%)] text-white px-24 py-20">
      <div className="flex-1 flex flex-col justify-center pr-16">
        <Smartphone className="w-14 h-14 mb-6 text-[hsl(174_72%_46%)]" />
        <h2 className="text-[48px] font-bold mb-6">Мобильное приложение</h2>
        <p className="text-[24px] text-white/60 mb-10">Учитесь где угодно — с телефона или планшета</p>
        <div className="space-y-5">
          {[
            ...
            <div key={i} className="flex items-center gap-4">
              <t.icon className="w-6 h-6 text-[hsl(174_72%_46%)]" />
              <span className="text-[22px]">{t.text}</span>
            </div>
          ))}
        </div>
      </div>
...
function SlideCTA() {
  return (
    <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-[hsl(0_0%_8%)] to-[hsl(0_0%_18%)] text-white px-24 py-20">
      <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.6 }}>
        <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-[hsl(174_72%_46%)] to-[hsl(174_65%_35%)] flex items-center justify-center mb-10 mx-auto">
...
export default function PlatformPresentation() {
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 bg-black flex items-center justify-center overflow-hidden select-none"
      ...
      {/* Bottom nav */}
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-black/60 backdrop-blur-md rounded-full px-6 py-3 z-50">
        ...
        <span className="text-white/80 text-sm font-medium min-w-[60px] text-center">{current + 1} / {TOTAL_SLIDES}</span>
      ...
      <div className="fixed bottom-20 left-1/2 -translate-x-1/2 flex gap-1.5 z-50">
        {slides.map((_, i) => (
