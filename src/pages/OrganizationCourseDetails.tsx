      ...
      <header className="sticky top-0 z-30 bg-card border-b border-border">
        ...
        <div className="flex items-center justify-between px-4 lg:px-6 h-14">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="icon" className="rounded-xl" onClick={() => navigate("/organization")}>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            ...
            <Button variant="ghost" size="sm" className="hidden lg:flex rounded-full gap-1.5 text-xs text-muted-foreground hover:text-foreground h-9 px-3" onClick={() => navigate("/partner")}>
            ...
            <DropdownMenu>
              <Tooltip>
                <TooltipTrigger asChild>
                  <DropdownMenuTrigger asChild>
                    <button className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/15 text-primary hover:bg-primary/25 hover:scale-105 transition-all font-bold text-sm">{initials}</button>
                  </DropdownMenuTrigger>
                </TooltipTrigger>
              ...
              <DropdownMenuContent align="end" className="w-52 rounded-xl">
                ...
                <DropdownMenuItem onClick={() => window.open("https://t.me/sintagma_support", "_blank")} className="rounded-lg gap-2.5 py-2.5"><HelpCircle className="w-4 h-4" />Помощь</DropdownMenuItem>
                <DropdownMenuSeparator />
