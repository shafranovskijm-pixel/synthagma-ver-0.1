...
/**
 * Официальный классификатор ФИС ФРДО — "Наименование области профессиональной
 * деятельности" (33 значения).
 *
 * ВАЖНО: строки должны совпадать с классификатором Рособрнадзора посимвольно,
 * включая «двойной пробел» внутри значения «Сервис, оказание услуг населению
 * (...предоставление персональных услуг,  услуги гостеприимства,...)».
 * Не нормализуйте пробелы — иначе валидатор отбракует строку.
 */
