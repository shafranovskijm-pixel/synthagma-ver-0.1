...
export const PROPOSAL_TEMPLATES: ProposalTemplate[] = [
  ...
  },
  {
    ...
    serviceLines: [
      {
        custom_name: `Тариф "${SUBSCRIPTION_PLANS.maximum.name}"`,
        custom_description: buildTariffDescription('maximum'),
        price: SUBSCRIPTION_PLANS.maximum.price,
        quantity: 12,
      },
      {
        custom_name: 'Настройка платформы',
        custom_description: 'Полная настройка всех модулей',
        price: 15000,
        quantity: 1,
      },
      {
        custom_name: 'Брендирование',
        custom_description: 'Полная кастомизация платформы под бренд',
        price: 5000,
        quantity: 1,
      },
      {
        custom_name: 'Интеграция ФРДО',
        custom_description: 'Настройка выгрузки данных в ФИС ФРДО',
        price: 10000,
        quantity: 1,
      },
      {
        custom_name: 'Генерация документов',
        custom_description: 'Настройка всех шаблонов документов',
        price: 5000,
        quantity: 1,
      },
      {
        custom_name: 'Персональный менеджер',
        custom_description: 'Выделенный менеджер на 12 месяцев',
        price: 0,
        quantity: 1,
      },
    ],
