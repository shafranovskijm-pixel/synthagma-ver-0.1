...
type LessonTypeOption = { type: LessonType; icon: LucideIcon; label: string; description: string; iconClass: string; disabled?: boolean; badge?: string };
...
const LESSON_TYPE_OPTIONS: LessonTypeOption[] = [
  ...
  { type: "ai_avatar", icon: Sparkles, label: "ИИ-преподаватель", description: "Голосовой диалог с ИИ-аватаром на тему урока. Функция в бета-тестировании — скоро будет доступна.", iconClass: "text-fuchsia-500 bg-gradient-to-br from-fuchsia-500/10 to-pink-500/10", disabled: true, badge: "Beta — скоро" },
];
