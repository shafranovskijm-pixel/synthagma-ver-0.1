...
export function Footer() {
  return (
    <footer className="bg-[hsl(222,47%,6%)] text-white py-20 relative overflow-hidden">
      <StarfieldCanvas />
      
      {/* Subtle accent glow line */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-px bg-gradient-to-r from-transparent via-[hsl(174,72%,46%)]/30 to-transparent z-[1]" />
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-6 group">
              <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                <span className="font-display font-bold text-xl text-[hsl(222,47%,6%)]">Σ</span>
              </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col items-center md:items-start gap-1">
            ...
            <a href="https://24zxc.ru" target="_blank" rel="noopener noreferrer" className="text-white/30 text-xs hover:text-white/50 transition-colors">
