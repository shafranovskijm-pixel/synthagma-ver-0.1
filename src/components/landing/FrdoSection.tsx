        ...
        <ScrollReveal>
          <div className="text-center mb-10 max-w-3xl mx-auto">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4 tracking-tight">
              Подготовка данных для ФИС ФРДО с автоматическими проверками
            </h2>
            <p className="text-muted-foreground text-lg">
              СИНТАГМА помогает форматировать поля, очищать скрытые пробелы и находить
              незаполненные данные. Итоговый файл проверяет ответственный сотрудник организации.
            </p>
          </div>
        </ScrollReveal>
