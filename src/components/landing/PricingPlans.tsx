...
const featureDescriptions: Record<string, { description: string; minPlan: string }> = {
  ...
  "Видеоидентификация": { description: "Фиксация результата проверки личности перед выдачей доступа к обучению.", minPlan: "Бесплатный" },
  "Брендирование": { description: "Логотип и цвета организации в кабинете и на доступных публичных страницах.", minPlan: "Бесплатный" },
  ...
  "ФИС ФРДО": { description: "Подготовка и выгрузка файлов XLSX по шаблонам ДПО и ПО на 41/35 столбцов с проверкой данных.", minPlan: "Бесплатный" },
  "Вебинары": { description: "Проведение встроенных вебинаров LiveKit и подключение внешних трансляций.", minPlan: "Профессиональный" },
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="text-xs text-[hsl(38,92%,50%)]/80">
            ФИС ФРДО+ — услуга выгрузки данных специалистом; состав работ и условия согласуются отдельно
          </span>
        </motion.p>
        ...
        >
          ...
          <p className="mt-3 text-xs text-muted-foreground max-w-md">
            Откройте коммерческое предложение и скачайте его в PDF для согласования
          </p>
        </motion.div>
      </div>
    </section>
