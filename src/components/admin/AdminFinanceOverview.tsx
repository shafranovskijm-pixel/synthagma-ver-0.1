...
import { CreditCard, Building2, ArrowDownCircle, Search, RefreshCw } from "lucide-react";
...
export function AdminFinanceOverview() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Table */}
      <Card>
        <CardHeader><CardTitle className="text-base">Все платежи</CardTitle></CardHeader>
        <CardContent>
          {loading ? (
