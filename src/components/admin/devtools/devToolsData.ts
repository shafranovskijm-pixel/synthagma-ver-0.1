...
export const LARGEST_FILES: LargeFile[] = [
  { path: "src/components/admin/OrganizationDetailsView.tsx", lines: 1969, status: "needs-work", note: "Критично. Нужна декомпозиция на подкомпоненты + контекст." },
  ...
  { path: "src/components/admin/OrganizationsManager.tsx", lines: 1160, status: "needs-work", note: "Декомпозиция: таблица + диалоги." },
...
export const QUALITY_METRICS: QualityMetric[] = [
  ...
  { label: "Крупнейший файл", value: 1969, max: 500, unit: "строк", status: "critical" },
  { label: "Файлов >800 строк", value: 26, max: 0, unit: "штук", status: "critical" },
  { label: "Файлов >500 строк", value: 57, max: 10, unit: "штук", status: "critical" },
  ...
  { label: "Кастомные хуки", value: 70, max: 100, unit: "штук", status: "good" },
  { label: "Context Coverage", value: 85, max: 100, unit: "%", status: "good" },
  { label: "Edge-функции", value: 59, max: 60, unit: "штук", status: "good" },
...
export const CODE_RECOMMENDATIONS: Recommendation[] = [
  // ── Критичные проблемы ──
  {
    ...
    title: "⚠️ OrganizationDetailsView — 1969 строк",
    detail: "Самый большой файл проекта. Нужна декомпозиция: вынести табы в отдельные компоненты, логику в хук, использовать Context.",
    actionable: true,
    status: "unchecked",
  },
  {
  ...
  },
  {
    ...
    severity: "error",
    category: "architecture",
    title: "⚠️ 26 файлов > 800 строк",
    detail: "Проект содержит 26 файлов более 800 строк и 57 файлов более 500 строк. Целевой максимум — 500 строк на файл.",
    actionable: true,
    status: "unchecked",
  },
  // ── Предупреждения ──
  {
    ...
    severity: "warn",
    category: "code",
    title: "⚠️ Покрытие тестами — 10 из 562 файлов",
  ...
  },
  {
    ...
    severity: "info",
    category: "code",
    title: "✅ 70 кастомных хуков создано",
  ...
  },
  {
    ...
    severity: "info",
    category: "architecture",
    title: "✅ 59 edge-функций развёрнуто",
    detail: "Auth (9), Notifications (11), AI (15), Documents (9), Media (6), Payments (3), System (6).",
    actionable: false,
    status: "applied",
  },
  {
