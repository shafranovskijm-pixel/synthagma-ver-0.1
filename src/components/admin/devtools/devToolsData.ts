...
export const CODE_RECOMMENDATIONS: Recommendation[] = [
  // ── Предупреждения (оставшиеся задачи) ──
  {
  ...
  },
  {
    ...
    severity: "warn",
    category: "code",
    title: "⚠️ Покрытие тестами — 10 из 550+ файлов",
  ...
  },
  {
    ...
    detail: "7 подкомпонентов в blocks/: TextBlocks, QuizBlock, MediaBlocks, SliderBlock, BlockContent, AddBlockButton, SortableBlockItem.",
    actionable: false,
    status: "applied",
  },
  {
    ...
    detail: "Логика → useAdminAnalytics. 7 графиков: RegistrationsChart, ActivityChart, VisitsChart, CompletionsChart, PaymentsChart, FeaturesChart, OverviewCards.",
    actionable: false,
    status: "applied",
  },
  {
    ...
    severity: "info",
    category: "architecture",
    title: "✅ CoursesTab оптимизирован (1747 → 1383)",
    detail: "Извлечены CoursesEmptyState, SortableCourseListRow, CategoryDialog, CreateCourseDialog, MoveCourseDialog, BulkDeleteDialog.",
    actionable: false,
    status: "applied",
  },
  {
  ...
  },
  {
    ...
    severity: "info",
    category: "code",
    title: "✅ 82 кастомных хука создано",
