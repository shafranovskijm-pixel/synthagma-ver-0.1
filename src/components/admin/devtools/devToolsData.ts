...
export const CODE_RECOMMENDATIONS: Recommendation[] = [
  ...
  },
  {
    ...
    severity: "warn",
    category: "architecture",
    title: "✅ TabContentRenderer + SettingsTab переведены на Context",
    detail: "TabContentRenderer: ~50 props → Context. SettingsTab: ~20 props → Context. OrganizationDashboard: 214 → ~140 строк. Все интерфейсы props удалены.",
    actionable: false,
    status: "applied",
  },
  {
