...
export const CODE_RECOMMENDATIONS: Recommendation[] = [
  // ── Критичные (error) — все выполнены ──
  {
    id: "course-preview-decompose",
    severity: "info",
    category: "architecture",
    title: "✅ CoursePreview.tsx — 1248 → 280 строк",
  ...
  },
  {
    ...
    detail: "Логика → useSelfExaminationQuiz. UI: QuizQuestion, QuizResults, QuizProgress.",
    actionable: false,
    status: "applied",
  },
  {
    ...
    severity: "info",
    category: "architecture",
    title: "✅ AutoDocumentRegistrationJournal.tsx — 1226 → 217 строк",
    detail: "Логика → useDocumentRegistrationJournal. UI упрощён.",
    actionable: false,
    status: "applied",
  },
  {
    ...
    detail: "Подкомпоненты: StudentTableRow, StudentMobileCard, StudentsEmptyState, StudentConfirmDialogs.",
    actionable: false,
    status: "applied",
  },
  {
    ...
    severity: "info",
    category: "architecture",
    title: "✅ OrganizationsManager.tsx — 1178 → 180 строк",
    detail: "Логика → useOrganizationsManager + OrgFormDialog + OrgStatsCards + OrgListView/OrgGridView.",
    actionable: false,
    status: "applied",
  },
  {
    id: "billing-decompose",
    severity: "info",
    category: "architecture",
    title: "✅ AdminBillingOverview.tsx — 1076 → 220 строк",
    detail: "Логика → useAdminBilling + подкомпоненты биллинга.",
    actionable: false,
    status: "applied",
  },
  {
    id: "org-documents-decompose",
    severity: "info",
    category: "architecture",
    title: "✅ OrgDocumentsManager.tsx — 1075 → 290 строк",
    detail: "Логика → useOrgDocumentsManager + OverviewContent, DocumentRow, SpecialCategoryContent, OrderDocumentsDialog.",
    actionable: false,
    status: "applied",
  },
  {
    id: "company-detail-decompose",
    severity: "info",
    category: "architecture",
    title: "✅ CompanyDetailDialog.tsx — 975 → 350 строк",
    detail: "Разбит на CompanyHeader, StatCard, ActionsGrid, DocumentSection, DocumentItem, CompanyAccessTab, CompanyRequestsOrgView.",
    actionable: false,
    status: "applied",
  },
  {
    id: "content-generator-decompose",
    severity: "info",
    category: "architecture",
    title: "✅ ContentGeneratorTab.tsx — 975 → 200 строк",
    detail: "Логика → useContentGenerator + CategoryOverview + CategoryDetailView.",
    actionable: false,
    status: "applied",
  },
  // ── Предупреждения (warn) — оставшиеся задачи ──
  {
    id: "large-files-count",
    severity: "warn",
    category: "architecture",
    title: "⚠️ 10 файлов > 800 строк (было 20)",
    detail: "Следующие кандидаты: AISettingsManager (874), BulkContentGenerator (867), InvoiceGenerator (846), JournalsManager (841), ConsentGenerator (834).",
    actionable: true,
    status: "checked",
  },
  {
