...
export const CODE_RECOMMENDATIONS: Recommendation[] = [
  ...
  },
  {
    ...
    severity: "warn",
    category: "architecture",
    title: "✅ TabContentRenderer переведён на Context",
    detail: "TabContentRenderer: ~50 props заменены на useOrgDashboard(). OrganizationDashboard уменьшен с 214 до ~140 строк. Интерфейс TabContentRendererProps удалён.",
    actionable: false,
    status: "applied",
  },
  {
