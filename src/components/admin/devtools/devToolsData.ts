...
export const CODE_RECOMMENDATIONS: Recommendation[] = [
  ...
  },
  {
    ...
    severity: "warn",
    category: "architecture",
    title: "DialogsContainer получает ~160 props",
    detail: "OrganizationDashboard передаёт ~160 props в DialogsContainer. Рекомендуется React Context или композиция.",
    actionable: false,
    status: "unchecked",
  },
  {
