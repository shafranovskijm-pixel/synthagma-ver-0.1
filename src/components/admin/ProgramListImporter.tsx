...
export function ProgramListImporter({ onComplete }: ProgramListImporterProps) {
  ...
  const parsePrograms = (text: string): ProgramEntry[] => {
    ...
    const knownPrograms: ProgramEntry[] = [
      ...
      { title: "Использование (применение) средств индивидуальной защиты", hours: "16", category: "Охрана труда" },
      ...
      { title: "Обеспечение экологической безопасности в области обращения с отходами I-IV классов опасности", hours: "40", category: "Экология" },
      { title: "Обеспечение экологической безопасности руководителями и специалистами общехозяйственных систем управления", hours: "72", category: "Экология" },
      { title: "Профессиональная подготовка лиц допущенных к обращению с отходами I-IV классов опасности", hours: "116", category: "Экология" },
      { title: "Анализ газовоздушной среды на санитарно-допустимые нормы", hours: "16", category: "Охрана труда" },
      // Рабочие профессии
