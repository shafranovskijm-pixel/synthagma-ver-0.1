      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-zinc-900/80 border border-cyan-500/20 p-5 font-mono text-sm space-y-2">
          {items.map((item, i) => {
            ...
            return (
              <div key={i} className="relative group border-b border-cyan-500/10 last:border-0 pb-2 last:pb-0">
                {isEditing && (
                ...
                >
                  ...
                  {isEditing ? (
                    ...
                    <span className="flex-1 text-cyan-100">{item.question}</span>
                  )}
                  {!isEditing && (
                ...
                {isOpen && (
                  <div className="pl-6 pr-2 pb-2 text-zinc-400 text-xs leading-relaxed">
