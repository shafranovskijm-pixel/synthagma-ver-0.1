            ...
            <Card className="max-w-4xl mx-auto overflow-hidden border-0 shadow-lg">
              ...
              <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-8 text-white">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold">Вебинары и онлайн-трансляции</h2>
                    <p className="text-white/80 mt-1">Проводите живые занятия и сохраняйте записи для повторного просмотра</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-xl bg-purple-50 dark:bg-purple-900/10 border border-purple-200 dark:border-purple-800/30">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-foreground">Доступно с тарифа <span className="text-purple-600 font-bold">Профессиональный</span></span>
                  </div>
                  <Button 
                    className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl gap-2"
                    onClick={() => dashboard.tabNavigation.setActiveTab("subscription" as any)}
                  >
                    Перейти к тарифам
