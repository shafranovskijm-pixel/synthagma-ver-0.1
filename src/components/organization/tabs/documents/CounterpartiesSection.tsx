...
import { ScrollText, Receipt, FileCheck, Download, FileText, Lightbulb, Eye, Trash2, ExternalLink, Building2, User, Store, Plus, FolderOpen, ChevronDown, ChevronRight, X, Search, Send, History, FilePlus2, Link2 } from "lucide-react";
import { extractInvoiceId, stripInvoiceMarker } from "@/utils/generateAct";
