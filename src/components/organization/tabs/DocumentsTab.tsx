...
const SECTION_DESCRIPTIONS: Partial<Record<DocumentSubTab, string>> = {
  ...
  org: "Загрузите документы организации и проверьте их применимость к вашим программам",
  ...
  frdo: "Подготовка XLSX для последующей загрузки в ФИС ФРДО",
  ...
  if (!documentView) {
    const primaryWorkspaces = [
      ...
      },
      {
        ...
        title: "Журналы",
        description: "Базовые, автоматические и собственные журналы организации",
        icon: ClipboardList,
      ...
      },
      {
        id: "frdo" as const,
        title: "ФИС ФРДО",
        description: "Проверка полей и подготовка XLSX для последующей загрузки",
        icon: Database,
        visible: canReadFrdo,
      },
      {
