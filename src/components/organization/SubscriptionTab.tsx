                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                      {FEATURE_HIGHLIGHTS.filter(f => PLAN_ORDER.indexOf(f.minPlan) > s.currentPlanIndex && !(f.categoryKey && s.customEnabledCategories.includes(f.categoryKey))).map((feature, i) => (
