...
<table style="font-size:10px">
  <thead>
    <tr>
      <th>№</th>
      <th>Наименование документа и организации, выдавшей документ</th>
      <th>Наименование программы, номер группы, срок обучения</th>
      <th>Регистрационный номер, дата выдачи</th>
      <th>Серия и номер бланка</th>
      <th>ФИО лица, получающего документ</th>
      <th>Год рождения</th>
      <th>Пол</th>
      <th>Серия и номер документа, удостоверяющего личность</th>
      <th>Гражданство</th>
      <th>№ и дата приказа о завершении обучения</th>
      <th>Подпись руководителя организации, выдавшей документ</th>
      <th>Подпись лица, получившего документ</th>
      <th>Подпись лица, получающего документ по доверенности</th>
      <th>Отметка об утрате или обмене</th>
      <th>Подпись лица, которому выдан дубликат</th>
    </tr>
  </thead>
