...
export const START_PLAN_CONTRACT_SUBJECT =
  "предоставление Заказчику и слушателям Заказчика доступа к образовательной платформе «СИНТАГМА» по тарифу «Старт» в режиме 24/7, за исключением времени проведения регламентных, профилактических и аварийно-восстановительных работ, с использованием функционала платформы: личные кабинеты Заказчика и слушателей, размещение и прохождение образовательных курсов, цифровая библиотека учебных и методических материалов, видеоматериалы и защищённое воспроизведение через Kinescope, видеоидентификация слушателей, ведение данных слушателей, контроль прогресса обучения, тестирование, электронные журналы и отчёты, чек-лист документов, подготовка данных для ФИС ФРДО, настройки порядка прохождения курсов, брендирование кабинета Заказчика, инструменты охраны труда, ИИ-генерация и ИИ-озвучка учебных материалов, email-рассылки и сервисные уведомления. В рамках тарифа «Старт» Заказчику предоставляется возможность использовать до 15 курсов, до 100 слушателей, до 60 завершивших обучение слушателей в месяц и до 3 ГБ хранилища данных.";
