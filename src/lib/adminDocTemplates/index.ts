...
export type SubscriptionPlanKey = "start" | "basic" | "professional" | "maximum" | "free";
...
export const PLAN_CONTRACT_SUBJECTS: Record<SubscriptionPlanKey, string> = {
  ...
  basic: `предоставление Заказчику и слушателям Заказчика доступа к образовательной платформе «СИНТАГМА» по тарифу «Базовый» в режиме 24/7 с использованием функционала платформы: ${PLAN_CORE_FUNCTIONS}, а также расширенных лимитов по количеству курсов, слушателей и объёма хранилища согласно тарифному плану, действующему на дату подписания Договора`,
