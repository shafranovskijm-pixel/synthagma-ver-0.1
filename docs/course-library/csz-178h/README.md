...
После повторной проверки подтверждены четыре рабочие официальные замены:

- приказ МЧС № 1156 — `https://mchs.gov.ru/dokumenty/7404`;
- постановление Правительства РФ № 1479 — `https://mchs.gov.ru/dokumenty/602`;
- актуальный каталог сводов правил МЧС;
- официальный PDF DoorHan для сдвижных противопожарных ворот.

После этих замен остаются восемь `HOLD`: четыре недоступных из текущей сети официальных записи, два видео без подтверждённого официального происхождения, один HTTPS-ресурс с неверным сертификатом и одно руководство на CDN продавца вместо сайта изготовителя.
...
3. Восемь кандидатов остаются `HOLD`; четыре подтверждённые замены ещё не утверждены для итогового манифеста.
